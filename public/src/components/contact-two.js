        ...
        <div className="row">
          <div className="col-md-6">
            <div className="contact-right contact_details">
              ...
              <p>
              Contact us today to receive a free, no-obligation quote for our HVAC services. 
              Our team is ready to assist you with any heating, ventilation, or air conditioning needs.
